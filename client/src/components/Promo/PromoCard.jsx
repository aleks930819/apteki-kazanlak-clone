...
const PromoCard = ({ image, name, description, newPrice, oldPrice }) => {
  return (
    <li className="promo-card-top flex flex-col promo-card-left promo-card relative m-2 mb-10 h-[450px] w-full cursor-cell transition duration-300 ease-in-out">
