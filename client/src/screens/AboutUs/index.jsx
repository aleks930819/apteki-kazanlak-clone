...
const AboutUsScreen = () => {
  ...
  return (
    <main className=" bg-grey-lighter-2">
      <AboutUsBanner />
      <section
        className="
      container mx-auto
      ...
      >
        <article>
          <p>
            ...
            Отваряйки врати през далечната <strong>1991г</strong>., първата
            частна аптека дава началото на това, което днес наричаме съвременна
            фармация. Вече повече от четвърт век ние сме близо до нашите
            пациенти. Грижим се за тяхното здраве, помагаме им в лечението на
            хроничните заболявания, винаги се стараем да намерим заедно
            правилното лечение.
          </p>
          <br />
          <p>
